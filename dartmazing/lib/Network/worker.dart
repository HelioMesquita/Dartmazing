...
class Worker extends WorkerAbstract {
  ...
  Future<NativeResponse<T>> fetch<T>({BaseRequest request, T factory(Map<String, dynamic> json)}) async {
    final responseNative = await network.execute(request: request, factory: factory);
